<template>
    <div>
        <nav class="bg-[#b5d4f3] fixed top-0 z-30 w-full">
            <div class="navbar relative">
                 <div class="flex-1">
                    <div class="flex items-center gap-2">
                        <a class="btn btn-ghost text-base sm:text-sm md:text-md lg:text-xl xl:text-2xl text-[#fff]
                            break-words whitespace-normal leading-tight lg:leading-normal">
                            xxxx
                            <span class="hidden lg:inline">xxxxx</span>
                            <span class="inline lg:hidden">xxx</span>
                        </a>
